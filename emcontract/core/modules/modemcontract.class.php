...
class modemcontract extends DolibarrModules
{
    ...
    // Data directories to create when module is enabled
		$this->dirs = array("/emcontract/temp");
    ...
    $this->rights[$r][0] = 75001; 				// Permission id (must not be already used)
		$this->rights[$r][1] = 'Consulter tous les contrats de travail';	// Permission label
		$this->rights[$r][3] = 0; 					// Permission by default for new user (0/1)
		$this->rights[$r][4] = 'view';				// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
		$this->rights[$r][5] = 'all';				// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
		$r++;

    /*
		$this->rights[$r][0] = 75002; 				// Permission id (must not be already used)
		$this->rights[$r][1] = 'Consulter son propre contrat de travail';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		$this->rights[$r][4] = 'view';				// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
		$this->rights[$r][5] = 'own';				// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
		$r++;
    */

		$this->rights[$r][0] = 75003; 				// Permission id (must not be already used)
		$this->rights[$r][1] = 'Ajouter un contrat de travail';	// Permission label
		$this->rights[$r][3] = 0; 					// Permission by default for new user (0/1)
		$this->rights[$r][4] = 'add';				// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
		$this->rights[$r][5] = '';				// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
		$r++;

		$this->rights[$r][0] = 75004; 				// Permission id (must not be already used)
		$this->rights[$r][1] = 'Supprimer un contrat de travail';	// Permission label
		$this->rights[$r][3] = 0; 					// Permission by default for new user (0/1)
