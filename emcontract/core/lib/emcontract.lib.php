...
function emcontract_prepare_head($object)
{
    ...
    $head[$h][0] = DOL_URL_ROOT . '/emcontract/fiche.php?id='.$object->id;
    ...
    $head[$h][0] = DOL_URL_ROOT.'/emcontract/document.php?id='.$object->id;
	  $head[$h][1] = $langs->trans("Documents");
	  $head[$h][2] = 'documents';
	  $h++;
    
    $head[$h][0] = DOL_URL_ROOT . '/emcontract/info.php?id=' . $object->id;
