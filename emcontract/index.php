...
/**
 *   	\file       htdocs/emcontract/index.php
...
if(!empty($search_employee) && $search_employee != -1) {
    $filter.= " AND em.fk_user = '".$db->escape($search_employee)."'\n";
}
...
if (!$user->rights->emcontract->view->all || $id > 0)
{
...
// User
if($user->rights->emcontract->view->all) {
    print '<td class="liste_titre" align="left">';
    $form->select_users($search_employee,"search_employee",1,"",0,'');
    print '</td>';
} 
else {
